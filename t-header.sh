...
do
	tput civis
	echo -ne "\033[34m\r[*] Mengunduh.. harap tunggu.........\e[33m[\033[32m$i\033[33m]\033[0m   ";
	sleep $delay
...
echo "";
echo -e "\e[1;34m[*] \e[32minstall paket....\e[0m";
echo "";
...
if [ -e $PREFIX/share/figlet/Remo773.flf ]; then
	echo -e "\e[1;34m[*] \033[32mRidwanz.flf figlet font is present\033[0m";
	sleep 4
else
wget https://raw.githubusercontent.com/Ridwanz-Saputra/RIDWANZ/master/Ridwanz.flf &> /dev/null;
sleep 3
cp Ridwanz.flf $PREFIX/share/figlet/Ridwanz.flf;
...
do
	echo ""
tput setaf 3
read -p "Harap Masukan Nama : " PROC
tput sgr 0
if [[ ${#PROC} -gt 8 ]]; then
	echo -e "\e[1;34m[*] \033[32mKarakter terlalu panjang Anda memiliki masukan...\033[0m"
	echo ""
	echo -e "\033[32mHarap kurang dari \033[33m9 \033[32mNama Karakter\033[0m" | pv -qL 10;
	echo ""
	sleep 4
	clear
echo -e "\033[01;32m
...
\033[0m";
	echo ""
	echo -e "\e[1;34m \033[32mMasukkan kurang dari 9 karakter...\033[0m"
	echo ""
else
	ok=1
fi
...
#echo -e '\033[1;43;30m### SUPPORT TERUS RIDWANZ SAPUTRA ### \033[0m';
#echo -e '\e[0;35m+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+\e[00m';
echo "";
echo -e "
...
tput setaf 3
read -p  "Anda ingin mengatur ini ? (y/n) " PROC32
tput sgr 0
if [[ ${PROC32} == [Y/y] ]]; then
...
source ~/.zshrc;
	...
	echo -e "\033[32mSemoga Anda menyukai karya saya..\033[0m"
fi
exit
}

clear;
echo -e "\033[31m$(figlet -f Ridwanz "T- Header")\e[0m"
echo -e "\e[1;32m
+----------------------------------*/
...
\033[0m";
tput setaf 3;
read -p  "Anda ingin mengatur ini ? (y/n) " PROC33
...
if [ -d $HOME/.oh-my-zsh ]; then
	...
	echo -e "\e[1;34m[*] \e[32mAnda Belum oh-my-zsh...\e[0m";
fi
while [ $ozsh = 0 ];
do
	echo -e "\e[1;34m[*] \e[32mOh-my-zsh pengaturan baru....\e[0m";
	echo "";
...
then
	...
	echo -e "\e[1;34m[*] \e[32munduhan gagal.. saya akan coba lagi..\e[0m";

fi
done

echo -e "\e[1;34m[*] \e[32mZsh-pengaturan plugin sugesti otomatis..\e[0m";
...
if [ -d $HOME/.plugins/zsh-syntax-highlighting ];then
	...
	echo -e "\e[1;34m[*] \033[32mSemoga Anda menyukai karya saya..\033[0m"
	exit
fi
exit 0
